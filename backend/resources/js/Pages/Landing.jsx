                        ...
                        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
                            {HOW.map((s) => (
                                <div key={s.n} className="card p-7 transition-colors hover:border-brand-400">
                                    <span className="text-3xl font-extrabold leading-none tracking-tight text-brand-700">{s.n}</span>
                    ...
                    <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
                        {PATHS.map((p) => (
                            <div key={p.code} className="card p-7 transition-colors hover:border-brand-400">
                                ...
                                <h3 className="mt-4 text-lg font-bold tracking-tight text-ink">{p.name}</h3>
