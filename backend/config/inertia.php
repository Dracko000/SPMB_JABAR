...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | NOTE: this project keeps its Inertia pages under `resources/js/Pages`
    | (capital P), so the default `js/pages` path does NOT match. We publish
    | the config so the view finder / ensure-pages-exist checks locate them.
    |
    */
